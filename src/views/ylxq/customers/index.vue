<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="需求产品 : 1:代运营   2  : 其他" prop="shopDemand">
        <el-input
          v-model="queryParams.shopDemand"
          placeholder="请输入需求产品 : 1:代运营   2  : 其他"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="customerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="业务员id" align="center" prop="id" />
      <el-table-column label="商店名称" align="center" prop="shopName" />
      <el-table-column label="联系人" align="center" prop="shopContacts" />
      <el-table-column label="手机号码" align="center" prop="phone" />
      <el-table-column label="商店地址" align="center" prop="shopAddress" />
      <el-table-column label="需求产品 : 1:代运营   2  : 其他" align="center" prop="shopDemand" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商店地址" prop="shopAddress">
          <el-input v-model="form.shopAddress" placeholder="请输入商店地址" />
        </el-form-item>
        <el-form-item label="需求产品 : 1:代运营   2  : 其他" prop="shopDemand">
          <el-input v-model="form.shopDemand" placeholder="请输入需求产品 : 1:代运营   2  : 其他" />
        </el-form-item>
        <el-form-item label="描述" prop="describe">
...
<script>
import { listCustomer, getCustomer, delCustomer, addCustomer, updateCustomer, exportCustomer } from "@/api/ylxq/customer";
