<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="密码" prop="qxCode">
        <el-input
          v-model="queryParams.qxCode"
          placeholder="请输入密码"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="loginList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="密码" align="center" prop="qxCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="密码" prop="qxCode">
          <el-input v-model="form.qxCode" placeholder="请输入密码" />
        </el-form-item>
        <el-form-item label="创建人" prop="createName">
...
<script>
import { listLogin, getLogin, delLogin, addLogin, updateLogin, exportLogin } from "@/api/ylxq/login";
